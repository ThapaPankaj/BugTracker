...
namespace bugtracker
{
    public partial class Admin_DashBoard_Panel : Form
    {
        ...
        public Admin_DashBoard_Panel(String username, String userRole)
        {
            InitializeComponent();
            display_bugfix_data();
        ...
        {
            String username = "xawbeenregmi";  //eha tero username
            String password = "timro password";  //eha tero pw
            String repo = "https://github.com/xawbeenregmi";   //eha tero github ko repo ko link
            String localfile = "C:/Users/xawbe/Documents/GitHub/Bug-Tracking-System--C--";  //eha tero kun folder ma xa ho tyo folder ko path   \ aaula error auxa / banai teshlai
            GitHubLink git =  new GitHubLink(username, password, repo, localfile);
            git.PushCommits();
